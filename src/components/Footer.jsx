      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
        ...
        <div>
          ...
          <div className="flex justify-center md:justify-start space-x-4 mt-3">
            <a href="https://www.facebook.com/p/Carbon-Institute-of-Paramedical-Science-Kasganj-61573842816946/" className="hover:text-gray-300" target="_blank">
              <Facebook size={24} />
            </a>
            <a href="#" className="hover:text-gray-300">
              <Twitter size={24} />
            </a>
            <a href="https://www.instagram.com/carbon.institute/" className="hover:text-gray-300" target="_blank">
              <Instagram size={24} />
            </a>
          </div>
        </div>
